<div class="row">
    <div class="col-md-4">
        <div class="panel panel-mint panel-colorful media middle pad-all">
            ...
            <div class="media-body">
                <p class="text-2x mar-no text-semibold"><?= $indo[0]['positif']?></p>
    ...
    <div class="col-md-4">
        <div class="panel panel-success panel-colorful media middle pad-all">
            ...
            <div class="media-body">
                <p class="text-2x mar-no text-semibold"><?= $indo[0]['sembuh']?></p>
    ...
    <div class="col-md-4">
        <div class="panel panel-danger panel-colorful media middle pad-all">
            ...
            <div class="media-body">
                <p class="text-2x mar-no text-semibold"><?= $indo[0]['meninggal']?></p>
              ...
              <div class="row">
					        <div class="col-md-8">
					            <div class="panel">
					                ...
					                <div class="pad-all">
					                    ...
					                    <div id="perbandingandatacovidindonesia" style="height:200px"></div>
					                </div>
					            </div>
					        </div>
                  ...
                  <?php
                  //Ubah ke non decimal
                  $datapos = $indo[0]['positif'];
                  $dataposout = str_replace( ',', '', $datapos);
                  //persenkan
                  $csembuhc = ($indo[0]['sembuh']/$dataposout)*100;
                  $cmeninggalc = ($indo[0]['meninggal']/$dataposout)*100;
                   ?>
                  <div class="col-md-2">
...
<div class="panel">
<div class="panel-heading">
    <h3 class="panel-title">Data Perkembangan Per-provinsi</h3>
</div>
    ...
    <table id="demo-foo-filtering" class="table table-bordered table-hover toggle-circle" data-page-size="10">
        <thead>
            <tr>
                ...
                <th data-toggle="true">Provinsi</th>
                <th>Positif</th>
                <th>Sembuh</th>
                <th>Meninggal</th>
            </tr>
...
<!-- End Foo Table - Filtering -->
  ...
  <!-- <?php require_once('halo.php') ; ?> -->

        <?php $positif = $indo[0]['positif'] ?>
        <?php $sembuh = $indo[0]['sembuh'] ?>
        <?php $meninggal = $indo[0]['meninggal'] ?>
        ...
        $(document).on('nifty.ready', function() {
          var chart = Morris.Area({
              element: 'perbandingandatacovidindonesia',
              data: [{
